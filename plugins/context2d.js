    ...
    jsPDFAPI.context2d = {
        ...
        fillText: function (text, x, y, maxWidth) {
            ...
            if (this.ctx._clip_path.length > 0) {
                var lines;
                if (this.pdf.internal.outIntercept) {
                    lines = this.pdf.internal.outIntercept.type === 'group' ? this.pdf.internal.outIntercept.stream : this.pdf.internal.outIntercept;
                } else {
        ...
        _fill: function (fillRule, isClip) {
            ...
            var moves = [];
            var outInterceptOld = this.pdf.internal.outIntercept;
            ...
            switch (this.ctx.globalCompositeOperation) {
                ...
                case 'destination-out':
                    ...
                    this.pdf.internal.outIntercept = obj;
                    break;
                default:
            ...
            this.pdf.internal.outIntercept = outInterceptOld;
